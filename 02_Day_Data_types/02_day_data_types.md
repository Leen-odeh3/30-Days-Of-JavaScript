...
console.log(age, mass, PI, boilingPoint, bodyTemp)
```
...
console.log(firstName.toUpperCase())  // LEEN

let country = 'palestine'

console.log(country.toUpperCase())    //PALESTINE
```
...
console.log(firstName.toLowerCase())  // leen
...
console.log(country.startsWith('pal'))   // true
console.log(country.startsWith('sti'))   // false
console.log(country.startsWith('las'))  //  false
```
...
let firstName = 'leen'      // string
let lastName = 'odeh'        // string
let age = 22                 // number, it is not my real age, do not worry about it
let job                         // undefined, because a value was not assigned

console.log(typeof 'leen')  // string
